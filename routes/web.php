...
Route::get('/asociado_cuentaahorro',[CuentaAhorroController::class,'cuenta_ahorro_data'])->middleware('auth','2fa')->name('cuentas.datos_ahorro');
Route::get('/asociado_cuentaaportacione',[CuentaAportacioneController::class,'cuenta_aportacione_data'])->middleware('auth','2fa')->name('cuentas.datos_aportacione');
//fin